...
const match = document.getElementById("gameTitle"); // where the title is displayed

var reset = document.getElementById("reset-button"); // works as game menu button and reset during middle of the game
...
let i = 0;
// randomises the cards every time.
cards.forEach(card => {
...
function disableCards() {
  ...
  if (numMatches === 4) {
    ...
    mySound.play()
		...
		score.innerHTML = "Score: " + numMatches + " out of 4";
